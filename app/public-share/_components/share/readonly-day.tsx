...
export default function ReadOnlyDay({ date, locations }: ReadOnlyDayProps) {
  return (
    <div className="h-full  w-[210px] md:w-[280px] 2xl:w-[300px]   border-0  md:border-2 overflow-y-auto border-gray-200 bg-white flex flex-col items-center px-2 md:pt-1 rounded-lg">
