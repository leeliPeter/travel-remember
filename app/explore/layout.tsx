    ...
    <>
      <div className="trip-page pb-6 h-full min-h-screen pt-[68px] md:pt-20 ">
        <div className=" mx-auto px-4">
          <div className="nav w-[70%] min-w-[250px] container mr-40 md:mr-auto  text-sm md:text-base mx-auto h-11 md:h-12 bg-white/20 backdrop-blur-sm space-x-2 rounded-lg mb-2 md:mb-6 flex justify-between items-center px-2">
            <Link
