...
export default function Share({ tripId }: ShareProps) {
  ...
  return (
    <div className="w-full h-[98vh] bg-white/50 rounded-lg overflow-hidden relative">
      <div className="group absolute top-10 z-20 right-2">
        <div
          onClick={handleShare}
          className="rounded-full cursor-pointer bg-green-400 transition-scale duration-1000 p-2 animate-bounce hover:animate-none"
        >
      ...
      {tripInfo ? (
        <div className="h-full flex flex-col">
          <div className="p-1 px-4 bg-white/90 border-b">
